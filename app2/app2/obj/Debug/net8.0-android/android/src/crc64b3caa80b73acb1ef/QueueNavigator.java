...
/** @hide */
	...
	public QueueNavigator (android.support.v4.media.session.MediaSessionCompat p0, int p1)
	{
		super (p0, p1);
		if (getClass () == QueueNavigator.class) {
			mono.android.TypeManager.Activate ("MediaManager.Platforms.Android.Queue.QueueNavigator, MediaManager", "Android.Support.V4.Media.Session.MediaSessionCompat, Xamarin.AndroidX.Media:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1 });
		}
	}
